    ...
    <div class="container">
      <section class="lots">
          <?php $res = empty($lots) ? 'Ничего не найдено по вашему запросу' : 'Результаты поиска по запросу';
            $search_res = isset($errors['search']) ? '' : $search; ?>
        <h2><?=$res;?> «<span><?=$search_res;?></span>»</h2>
        <ul class="lots__list">
          ...
          <li class="lots__item lot">
            <div class="lot__image">
              ...
              <?php $category = isset($categories[$value['category_name']]) ? $categories[$value['category_name']] : '';
        ...
        <?= include_template('pagination.php', [
            ...
            'cur_page' => $cur_page,
            'url' => '/page_content/search.php?search=' . $search . '&find=Найти'
        ]); ?>
    </div>
  </main>
