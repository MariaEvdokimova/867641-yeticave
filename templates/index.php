        ...
        <?php foreach ($announcement_list as $value): ?>
            <li class="lots__item lot">
                ...
                <div class="lot__info">
                    ...
                    <h3 class="lot__title"><a class="text-link" href="pages/lot.html"><?=htmlspecialchars($value['lot_name']); ?></a></h3>
                    <div class="lot__state">
                        ...
                        <div class="lot__timer timer">
                            <?=lot_timer(date_create("tomorrow midnight")); ?>
                            <!--lot_timer(date_create($value['end_datetime']))-->
